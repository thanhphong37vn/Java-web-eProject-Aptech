 ...
 * @author ThanhTung
 */
public class GetOneCatelogy extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                request.setAttribute("editcatelogy", ca);
            }
            
              request.getRequestDispatcher("/UpdateCatelogy.jsp").forward(request, response);
        } catch (Exception ex) {
            ex.printStackTrace();
        } finally {
            try {
