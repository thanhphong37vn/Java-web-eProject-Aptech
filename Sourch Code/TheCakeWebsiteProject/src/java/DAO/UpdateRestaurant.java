...
public class UpdateRestaurant extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String RestaurantName = request.getParameter("txtRestaurantName");
            ...
            stm = conn.prepareStatement("update Restaurant set RestaurantName=?,RestaurantAdress=?,RestaurantContent=?,RestaurantPhone=?,Chef=? where RestaurantId=?");
