                ...
                <div class="content-box"><!-- Start Content Box -->
                    ...
                    <div class="content-box-header">
                        ...
                        <ul class="content-box-tabs">
                            <li><a href="#tab1" class="default-tab">List Catelogy</a></li> <!-- href must be unique and match the id of target div -->
                    ...
                    <div class="content-box-content">
                        ...
                        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                            ...
                            <table>
                                ...
                                <tbody>
                                    <c:forEach items="${requestScope.listcategory}" var="admin">
                                        <tr>
                                            <td></td>
                                            <td>${admin.categoryID}</td>
                                            <td>${admin.categoryName}</td>

                                            <td>
                                                <!-- Icons -->
                                                <a href="GetOneCatelogy?id=${admin.categoryID}" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" /></a>
