                ...
                <div class="content-box"><!-- Start Content Box -->
                    ...
                    <div class="content-box-header">
                        ...
                        <ul class="content-box-tabs">
                            <li><a href="#tab1" class="default-tab">List Feedback</a></li> <!-- href must be unique and match the id of target div -->
                    ...
                    <div class="content-box-content">
                        ...
                        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                            ...
                            <table>
                                ...
                                <tbody>
                                    <c:forEach items="${requestScope.listfeedback}" var="admin">
                                        <tr>
                                            <td></td>
                                            <td>${admin.feedBackID}</td>
                                            <td>${admin.name}</td>
                                            <td>${admin.email}</td>
                                            <td>${admin.subject}</td>
                                            <td>${admin.content}</td>
                                            <td>${admin.feedbackDate}</td>

                                            <td>
                                                <!-- Icons -->
                                                <a href="Delete_Feedback?id=${admin.feedBackID}" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a>
