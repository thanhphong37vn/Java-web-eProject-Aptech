                ...
                <div class="content-box"><!-- Start Content Box -->
                    ...
                    <div class="content-box-header">
                        ...
                        <ul class="content-box-tabs">
                            <li><a href="#tab1" class="default-tab">List System Order</a></li> <!-- href must be unique and match the id of target div -->
                    ...
                    <div class="content-box-content">
                        ...
                        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                            ...
                            <table>
                                ...
                                <tbody>
                                    <c:forEach items="${requestScope.listorder}" var="ord">
                                        <tr>
                                            ...
                                            <td>${ord.emailRecipients}</td>
                                            <td>${ord.phoneRecipients}</td>

                                            <td>
                                                <!-- Icons -->
                                                <a href="DetailsOrder?id=${ord.ordersId}" title="DetailOrder"><img src="resources/images/icons/hammer_screwdriver.png" alt="Product Order" /></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
