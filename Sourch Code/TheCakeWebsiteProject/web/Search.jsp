...
<body>
	...
	<div id="content">
			...
			<h1>The Pastry shop</h1>
                        <table>
                            <c:forEach items="${requestScope.showPro}" var="sow">
                                <tr>
                                    <td>
                                        <img src="${sow.pictureProduct}" alt="images" width="300" height="300" />
                                    </td>
                                    <td>
                                        <h2>${sow.productName}</h2>
                                        <c:forEach items="${requestScope.showCatePro}" var="cate">
                                            <h3>Category Cake: ${cate.categoryName}</h3>
                                        </c:forEach>
                                        <h4 class="price">Price: <fmt:formatNumber type="currency" value="  ${sow.productPrice} "/></h4>
                                        <h4>Description: ${sow.productContent}</h4>
