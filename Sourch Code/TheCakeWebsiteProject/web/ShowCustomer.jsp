                ...
                <div class="content-box"><!-- Start Content Box -->
                    ...
                    <div class="content-box-header">
                        ...
                        <ul class="content-box-tabs">
                            <li><a href="#tab1" class="default-tab">List Customer</a></li> <!-- href must be unique and match the id of target div -->
                    ...
                    <div class="content-box-content">
                        ...
                        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                            ...
                            <table>
                                ...
                                <tbody>
                                     <c:forEach items="${requestScope.listCus}" var="cu">
                                        ...
                                        <tr>
                                            ...
                                            <td>${cu.customerAdress}</td>
                                            <td>${cu.customerPhone}</td>
                                            <td>${cu.customerSex}</td>
                                            <td>${cu.dob}</td>
                                            <td>${cu.anserSecret}</td>

                                            <td>
                                                <!-- Icons -->

                                                <a href="Delete_Customer?id=${cu.customerId}" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" /></a>
