                ...
                <div class="content-box"><!-- Start Content Box -->
                    ...
                    <div class="content-box-header">
                        ...
                        <ul class="content-box-tabs">
                            <li><a href="#tab1" class="default-tab">Type Product</a></li> <!-- href must be unique and match the id of target div -->
                        ...
                        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                            ...
                            <table>
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td>${requestScope.displaytype.categoryID}</td>
                                            <td>${requestScope.displaytype.categoryName}</td>
